...
def main():
    ...
    if show_about_me:
        st.markdown(
            "<h2>About Me</h2>"
            "<p>Hello! I am Suraj Kumar Yadav, a passionate developer interested in machine learning and web development. "
        ...
        st.markdown(
            ...
            <div class="social-icons">
                <a href="https://linkedin.com/in/surajyadav01">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png" alt="LinkedIn">
                </a>
                <a href="https://github.com/TheSuraj01">
                ...
                <a href="https://www.instagram.com/itz._.me._.suraj/">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/a/a5/Instagram_icon.png" alt="Instagram">
                </a>
                <a href="https://www.facebook.com/people/S-U-Raj/100010746067622/">
    ...
    st.markdown(
        '<div class="title"><u>MeDiCT</u> </br> Medical Diagnosis using Computer Vision</div>',
        unsafe_allow_html=True,
    )
    ...
    st.markdown('<div style="text-align: center; margin-top: 2rem;">'
                ...
                '© 2024 Suraj Kumar Yadav. All rights reserved.</p></div>', unsafe_allow_html=True)
